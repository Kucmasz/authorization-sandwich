...
extern const PLAT_UI16 stsafel_boot_time[1];
/* Exported variables --------------------------------------------------------*/
...
stse_ReturnCode_t stse_device_lock(stse_Handler_t *pSTSE, PLAT_UI8 *pPassword, PLAT_UI8 password_length) {
    stse_ReturnCode_t ret = STSE_PLATFORM_INVALID_PARAMETER;
#ifdef STSE_CONF_STSAFE_A_SUPPORT
...
#endif /* STSE_CONF_STSAFE_L_SUPPORT */
#ifdef STSE_CONF_STSAFE_A_SUPPORT
    ret = stsafea_get_command_count(pSTSE, pRecord_count);
#endif /* STSE_CONF_STSAFE_A_SUPPORT */
		return ret;
}
...
#endif /* STSE_CONF_STSAFE_L_SUPPORT */
#ifdef STSE_CONF_STSAFE_A_SUPPORT
	ret = stsafea_get_command_AC_table(pSTSE, record_count, pChange_rights, pRecord_table);
#endif /* STSE_CONF_STSAFE_A_SUPPORT */		
	return ret;
}
...
#endif /* STSE_CONF_STSAFE_L_SUPPORT */
#ifdef STSE_CONF_STSAFE_A_SUPPORT
	ret = stsafea_query_life_cycle_state(pSTSE, pLife_cycle_state);
#endif /* STSE_CONF_STSAFE_A_SUPPORT */	
	return ret;
}
